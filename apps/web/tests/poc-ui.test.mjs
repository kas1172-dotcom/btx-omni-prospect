...
test('sanitized reference classifications remain orthogonal and source-backed in Portfolio and Map', () => {
  ...
  assert.match(map, /Strategic partnership uses the audited manager designation/)
  assert.match(map, /personal shortlist is private to the signed-in user/)
  assert.match(map, /Industry Top 100 remains unavailable/)
