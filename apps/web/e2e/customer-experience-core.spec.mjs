...
test('desktop Portfolio composes accessible search, filters, sorting, and canonical Customer navigation', async ({ page }) => {
  ...
  await expect(page.getByText('Why this organization matters')).toBeVisible()
  ...
  await expect(page.getByRole('heading', { name: 'People and relationship paths' })).toBeVisible()
