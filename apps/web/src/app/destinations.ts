...
export const NAVIGATION_DESTINATIONS: readonly NavigationDestination[] = [
  ...
  { surface: 'intelligence', label: 'Intelligence', route: '#/intelligence', job: 'Review governed public and market developments.', requiredCapability: 'authenticated', desktop: 'primary', mobile: 'primary', group: 'commercial' },
  { surface: 'map', label: 'Map', route: '#/map', job: 'Explore governed organization and facility context.', requiredCapability: 'authenticated', desktop: 'primary', mobile: 'primary', group: 'commercial' },
  { surface: 'actions', label: 'Actions', route: '#/actions', job: 'Manage governed internal work.', requiredCapability: 'authenticated', desktop: 'primary', mobile: 'primary', group: 'commercial' },
