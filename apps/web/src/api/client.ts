...
export const api = {
  ...
  assistCommunication: (id: string, instruction: string) => actionRequest<{ draft: CommunicationDraft; proposal: { subject: string; body: string; evidence_ids: string[] }; provider_status: string; assisted: boolean; message: string }>(`/communications/${id}/assist`, { method: 'POST', body: JSON.stringify({ instruction }) }),
