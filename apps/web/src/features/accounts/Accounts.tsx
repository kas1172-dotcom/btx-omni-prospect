...
function CustomerDetail({ accounts, detail, initialAssessment, onSelect, onBack, onOmniContext }: { accounts: Account[]; detail: Account360; initialAssessment?: OmniAssessmentSelection; onSelect: (id: string) => void; onBack: () => void; onOmniContext: (context: Pick<OmniContext, 'selected_assessment' | 'relationship_selection'>) => void }) {
