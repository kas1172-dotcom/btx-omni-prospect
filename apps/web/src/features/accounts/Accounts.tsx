...
export type PortfolioSnapshot = { query: string; scope: Scope; industry: string; entity: Classification; top100: boolean; sortKey: SortKey; sortDirection: SortDirection; filtersOpen: boolean }
...
function Portfolio({ accounts, initialSnapshot, onSnapshot, onSelect, onOmniContext }: { accounts: Account[]; initialSnapshot?: PortfolioSnapshot; onSnapshot?: (snapshot: PortfolioSnapshot) => void; onSelect: (id: string) => void; onOmniContext: (context: Pick<OmniContext, 'active_filters' | 'visible_record_ids'>) => void }) {
  ...
  useEffect(() => { onSnapshot?.({ query, scope, industry, entity, top100, sortKey, sortDirection, filtersOpen }) }, [query, scope, industry, entity, top100, sortKey, sortDirection, filtersOpen, onSnapshot])
