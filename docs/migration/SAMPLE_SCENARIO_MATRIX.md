...
|---|---|---|
| Market universe | Top 100 for Commercial Aerospace, Defense, Space, Semiconductor, Medical Device, and Robotics; supported overlaps allowed | Identity, rank, industry, coordinates, domain, customer/target state, contact-role families, public-research eligibility, and basic commercial classification |
...
| B. Medical Device Market Penetration Review | Commercial leader | Medical current customers and prospects | Market universe, PRISM, CRM, facilities | Medical Top-100 rank, geography, invoiced/commercial presence, BU relationships, customer/target state | Map distinguishes present customers from whitespace; external rank remains separate from internal attractiveness; supports M&A research discussion without valuation/diligence claims. | Map, Accounts, Intelligence, Omni | “Where do we have Medical whitespace with existing commercial presence?” | Top-100 methodology, PRISM commercial facts, identity |
...
| H. Strong External / Weak Internal | Business development | Top-ranked target with little/no BTX history | Market universe, public research, CRM/PRISM absence | External rank, coordinates, role families, explicit absent internal history | Target remains visible as a market opportunity; rank never becomes Account Attractiveness; no internal relationship is invented. | Map, Accounts, Omni | “What do we know versus what remains unverified?” | Top-100 source, missingness model, contact research |
...
- What exact source and methodology defines Top-100 rank per industry?
