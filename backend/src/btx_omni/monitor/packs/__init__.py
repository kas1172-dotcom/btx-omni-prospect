...
PACKS = {
    "commercial_aerospace": IndustryPack("commercial_aerospace", (EventType.CONTRACT_AWARD, EventType.FACILITY_EXPANSION, EventType.PRODUCTION_RAMP, EventType.BACKLOG_CHANGE), ("sec_edgar", "company_newsroom", "federal_register"), ("commercial aircraft", "civil aviation", "MRO")),
    ...
    "space": IndustryPack("space", (EventType.CONTRACT_AWARD, EventType.PROGRAM_LAUNCH, EventType.GOVERNMENT_FUNDING, EventType.PARTNERSHIP), ("nasa", "sam_gov", "usaspending", "company_newsroom"), ("launch", "satellite", "spacecraft"), agency_ids=("NASA",)),
    "robotics": IndustryPack("robotics", (EventType.PRODUCT_LAUNCH, EventType.FACILITY_EXPANSION, EventType.CAPACITY_EXPANSION, EventType.PARTNERSHIP), ("sec_edgar", "company_newsroom", "state_economic_development"), ("robotics", "robotic system", "automation robot")),
