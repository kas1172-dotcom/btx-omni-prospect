...
PACKS = {
    "commercial_aerospace": IndustryPack("commercial_aerospace", (EventType.CONTRACT_AWARD, EventType.FACILITY_EXPANSION, EventType.PRODUCTION_RAMP, EventType.BACKLOG_CHANGE), ("sec_edgar", "company_newsroom", "federal_register"), ("airframe", "aerospace", "MRO")),
    ...
    "medical_device": IndustryPack("medical_device", (EventType.REGULATORY_APPROVAL, EventType.REGULATORY_CHANGE, EventType.PRODUCT_LAUNCH, EventType.FACILITY_EXPANSION), ("fda_openfda", "federal_register", "sec_edgar", "company_newsroom"), ("510(k)", "PMA", "ISO 13485")),
