...
network_import_batches = Table(
    "network_import_batches", metadata,
    Column("id", String(64), primary_key=True),
    ...
    Column("owner_person_id", String(64)),
    Column("status", String(32), nullable=False),
    Column("input_row_count", Integer, nullable=False),
    Column("imported_row_count", Integer, nullable=False),
...
network_people = Table(
    "network_people", metadata,
    Column("id", String(64), primary_key=True),
    Column("tenant_id", String(100), nullable=False),
    Column("kind", String(16), nullable=False),
    Column("display_name", String(300), nullable=False),
    Column("profile_url", Text),
    Column("batch_id", ForeignKey("network_import_batches.id"), nullable=False),
    Index("ix_network_people_tenant_kind", "tenant_id", "kind"),
    Index("ix_network_people_batch", "batch_id"),
)
network_affiliations = Table(
    "network_affiliations", metadata,
    Column("id", String(64), primary_key=True),
    Column("tenant_id", String(100), nullable=False),
    Column("person_id", ForeignKey("network_people.id"), nullable=False),
    Column("raw_company_string", String(500), nullable=False),
    Column("raw_title", String(500)),
    Column("account_id", ForeignKey("accounts.id")),
    Column("resolution_method", String(64), nullable=False),
    Column("resolution_state", String(32), nullable=False),
    Column("role_family", String(120), nullable=False),
    Column("seniority_tier", String(32), nullable=False),
    Column("as_of", DateTime(timezone=True), nullable=False),
    Column("evidence_state", String(32), nullable=False),
    Column("data_mode", String(32), nullable=False),
    Column("synthetic", Boolean, nullable=False),
    Index("ix_network_affiliations_account", "tenant_id", "account_id"),
    Index("ix_network_affiliations_person", "tenant_id", "person_id"),
)
network_ties = Table(
    "network_ties", metadata,
    Column("id", String(64), primary_key=True),
    Column("tenant_id", String(100), nullable=False),
    Column("internal_person_id", ForeignKey("network_people.id"), nullable=False),
    Column("external_person_id", ForeignKey("network_people.id"), nullable=False),
    Column("connected_on", DateTime(timezone=True)),
    Column("batch_id", ForeignKey("network_import_batches.id"), nullable=False),
    Column("tie_source", String(64), nullable=False),
    Column("evidence_state", String(32), nullable=False),
    Column("data_mode", String(32), nullable=False),
    Column("synthetic", Boolean, nullable=False),
    UniqueConstraint("tenant_id", "batch_id", "internal_person_id", "external_person_id", name="uq_network_tie"),
    Index("ix_network_ties_internal", "tenant_id", "internal_person_id"),
    Index("ix_network_ties_external", "tenant_id", "external_person_id"),
)
network_unresolved_companies = Table(
    "network_unresolved_companies", metadata,
    Column("id", String(64), primary_key=True),
    Column("tenant_id", String(100), nullable=False),
    Column("batch_id", ForeignKey("network_import_batches.id"), nullable=False),
    Column("company_fingerprint", String(64), nullable=False),
    Column("raw_company_string", String(500), nullable=False),
    Column("resolution_state", String(32), nullable=False),
    Column("resolution_method", String(64), nullable=False),
