...
def _event(
    ...
    return RawSignal(
        ...
        EvidenceState.CONFIRMED, summary, source_validation_state,
    )
...
SCENARIOS = (
    ...
    RichScenario("ge-aerospace", "NASA public propulsion research award provides a concrete program context.", "Validate public program relevance and route to an aerospace role-family target.", _event("NASA_PROPULSION", SignalKind.AWARD_CONTRACT, "NASA propulsion research contract announcement", "https://www.nasa.gov/news-release/nasa-awards-propulsion-research-contracts-to-five-firms/", "GE Aerospace", (2024, 9, 25), "NASA announcement naming propulsion research contractors."), STRONG),
    ...
    RichScenario("applied-materials", "Commerce public semiconductor-equipment context supports fit discovery.", "Review the official source and qualify only public evidence-backed relevance.", _event("CHIPS_APPLIED", SignalKind.EXPANSION, "Commerce semiconductor equipment incentive context", "https://www.commerce.gov/node/7087", "Applied Materials", (2025, 1, 16), "Commerce public semiconductor manufacturing announcement.", SourceValidationState.BROWSER_VERIFIED), WARM_DECLINING),
